            ...
            <div className="container mx-auto px-4"> 
                <div className="flex flex-wrap -mx-4"> 
                    ...
                    <div className="p-4 w-full sm:w-6/12 md:w-3/12 xl:w-2/12"> 
                        ...
                        <ul>
                            <li className="mb-4">
                                <Link href="/about"><a href="/about" className="hover:text-gray-400">About</a></Link>
                            </li>                             
                        </ul>                         
                    </div>                     
                    <div className="p-4 w-full sm:w-6/12 md:w-3/12 xl:w-2/12"> 
                        ...
                        <ul> 
                            <li className="mb-4">                                
                                <Link href="/domains"><a href="/domains" className="hover:text-gray-400">Domains</a></Link>
                            </li>                             
                            <li className="mb-4">
                                <Link href="/emails"><a href="/domains" className="hover:text-gray-400">Emails</a></Link>
                            </li>                             
                            <li className="mb-4">
                                <Link href="/hosting"><a href="/domains" className="hover:text-gray-400">Web Hosting</a></Link>
                            </li>                             
                            <li className="mb-4">
                                <Link href="/forums"><a href="/forums" className="hover:text-gray-400">Community Forum</a></Link>
                            </li>                             
                        </ul>                         
                    </div>                     
                    <div className="p-4 w-full md:w-6/12 xl:w-4/12"> 
                        ...
                        <div className="flex-wrap inline-flex space-x-3"> <a href="https://facebook.com/anjanesh" target="_blank" className="hover:text-blue-400" aria-label="facebook link"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5"> 
                                    <path d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z"/> 
                                </svg></a> <a href="https://twitter.com/anjanesh" target="_blank" className="hover:text-blue-400" aria-label="twitter link"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5"> 
                                    <path d="M22.162 5.656a8.384 8.384 0 0 1-2.402.658A4.196 4.196 0 0 0 21.6 4c-.82.488-1.719.83-2.656 1.015a4.182 4.182 0 0 0-7.126 3.814 11.874 11.874 0 0 1-8.62-4.37 4.168 4.168 0 0 0-.566 2.103c0 1.45.738 2.731 1.86 3.481a4.168 4.168 0 0 1-1.894-.523v.052a4.185 4.185 0 0 0 3.355 4.101 4.21 4.21 0 0 1-1.89.072A4.185 4.185 0 0 0 7.97 16.65a8.394 8.394 0 0 1-6.191 1.732 11.83 11.83 0 0 0 6.41 1.88c7.693 0 11.9-6.373 11.9-11.9 0-.18-.005-.362-.013-.54a8.496 8.496 0 0 0 2.087-2.165z"/> 
                                </svg></a> <a href="https://instagram.com/anjanesh" target="_blank" className="hover:text-blue-400" aria-label="instagram link"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5"> 
                                ...
                                </svg></a> <a href="https://www.linkedin.com/in/anjanesh/" target="_blank" className="hover:text-blue-400" aria-label="linkedin link"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5"> 
                                    <path d="M6.94 5a2 2 0 1 1-4-.002 2 2 0 0 1 4 .002zM7 8.48H3V21h4V8.48zm6.32 0H9.34V21h3.94v-6.57c0-3.66 4.77-4 4.77 0V21H22v-7.93c0-6.17-7.06-5.94-8.72-2.91l.04-1.68z"/> 
                                </svg></a> <a href="https://www.youtube.com/user/anjanesh" target="_blank" className="hover:text-blue-400 hidden" aria-label="youtube link"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5"> 
