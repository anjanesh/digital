        ...
        <div>
            ...
            <section className="bg-gray-100 relative text-gray-500"> 
                <div className="container mx-auto pt-24 px-4">
                    ...
                    <p className="pb-10 text-lg">I use <a className="underline text-blue-600 hover:text-blue-800" href="https://cloudflare.com" rel="noreferrer">CloudFlare</a> for domain management. It can also be managed at ResellerClub, BigRock or even Google but Cloudflare is the industry leader in this currently and has paid tiers @ $20 a month (per domain) for even better performance for clients having online business at a larger scale</p>
