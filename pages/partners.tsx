        ...
        <div>
            ...
            <section className="bg-gray-100 relative text-gray-500"> 
                <div className="container mx-auto pt-24 px-4">
                    ...
                    <img src="https://anjanesh.digital/sudhir.webp" alt="Sudhir" width="200" className='ml-5 float-right hidden md:block'/>
                    ...
                    <img src="https://anjanesh.digital/pratik.webp" alt="Pratik" width="200" className='ml-5 float-right hidden md:block' style={{ maxHeight: '300px' }}/>
                    <h2 className='text-3xl'>Pratik Borkar</h2>
                    <p className="pb-6 text-lg text-justify mt-5">Every one calls him a Smart-Ass freak but no one knows that he is an avid Apple Fan &amp; Technophilic who is passionate about new techno kind a stuff and Apple&lsquo;s new creation like OS X and iOS, Also He likes to share useful tips, techniques and resources for Hackintosh and Macintosh for Apple addicts on his personal blog.</p>
                    <p className='text-right'><a href="https://hackintoshmumbai.com" className="text-blue-900 hover:text-blue-500">hackintoshmumbai.com</a></p>
                    <p className='clear-both'><br/></p>
